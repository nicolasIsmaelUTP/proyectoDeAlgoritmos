...
public class Evaluador extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        areaTexto.setRows(5);
        areaTexto.setText("Nombre: \t\t Desarrollado por ......\nFecha: \t\t mayo del 2023 .\nTitulo del proyecto:\tPilas en Postfija.\nClase:\t\tEstructura de datos.\nHora:\t\t09-10 pm.\nAula:\t\t202.");
    ...
    /**
     * Metodo que se encarga de llamar a los demas metodos en forma ordenada
     * para generar el resultado de avaluar la exprecion
     */
    ...
    /**
     * Metodo que evalua la exprecion posfija y devuelve el valor real de la
     * evaluacion
     *
     ...
     * @return devuelve un String con la exprecion en postfijo o devuelve un
     * null si la exprecion no se evaluo correctamente
     */
     ...
     *
     * @param operacion esta variable deve de contener la operacion matematica a
     * efectuar Ejemplo: a+((b-c)/d)
    ...
    /**
     * Metodo que genera la posicion en la que se genero el error en tienpo de
     * evaluar la expreción
     *
    ...
    /**
     * Metodo utilizado para saber si el caracter es de mayor presedencia que el
     * que se encuentra en la ultma posicion de la pila
     *
     * @param caracter caracter que se evaluara para meterse a la pila
     * @return devuelve true si el caracter es de mayor presedencia, false de lo
     * contrario
     */
